...
(defn svg-control-box []
  [:svg {:width 120 :height 230}
   ...
   [:rect.bpm-ctr {:x 35 :y 130 :width 60 :height 30}]
   [:text.bpm-ctr {:x 60 :y 148 :text-anchor "middle"} @BPM]
   [control-btn "-" 15 130 25 30 (fn [] (swap! BPM - 5) (s/set-bpm clock (* 4 @BPM)))]
   [control-btn "+" 80 130 25 30 (fn [] (swap! BPM + 5) (s/set-bpm clock (* 4 @BPM)))]
